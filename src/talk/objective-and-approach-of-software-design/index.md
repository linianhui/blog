...
## 6.3 数据模型匹配业务 {#data-model-match-business}

数据模型匹配业务的含义是说让你的代码真实的表达实际的业务意图，而且这个意图必须要落实到数据层面，而非代码层面。**简而言之就是让你的数据体现你的业务，而不是你的代码体现你的业务**。感觉有点绕噢，什么鬼意思？我举个小例子：个税计算
...
## 7.1 可复用性只是一种现象 {#reusability-is-a-phenomenon}
