...
在[[程序设计语言] 02 [核心概念] 名字、作用域和约束(Bindings)](/programming-language/02-core-names-scopes-and-bindings/)中我们列举了对象的**3种存储类别 : 静态、栈和堆**。静态对象在程序的执行期间始终是活动的，栈对象在它们的声明所在的子程序执行期间是活动的，而堆对象则没有明确定义活动时间。
